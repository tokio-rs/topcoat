use topcoat_view::{Markup, svg::ViewBox};
...
impl IconData {
    ...
    #[must_use]
    pub fn new(view_box: ViewBox, body: Markup) -> Self {
        Self { view_box, body }
    }
    ...
    pub const fn unescaped_unchecked(view_box: ViewBox, body: &'static str) -> Self {
        Self {
            view_box,
            body: Markup::unescaped_unchecked(body),
        }
    }
    ...
    #[must_use]
    pub fn into_body(self) -> Markup {
        self.body
    }

    /// The icon's body view.
    #[must_use]
