...
use crate::{ClassViewParts, Markup, PartsWriter, PromotedStr, StaticStr, Unescaped};
...
impl AttributeValueViewParts for Unescaped<Markup> {
    #[inline]
    fn attribute_present(&self) -> bool {
        true
    }
...
impl AttributeValue {
    ...
    #[inline]
    pub(crate) fn captured(view: Markup) -> Self {
        Self { view: Some(view) }
    }
