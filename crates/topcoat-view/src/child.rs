...
///
/// Insert this value in the component's template to render the children
/// there. They render concurrently with the rest of the template. Children
/// that are never rendered never run.
pub struct Child<'a> {
    view: BoxView<'a>,
}
