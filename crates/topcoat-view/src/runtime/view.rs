...
use crate::runtime::{Formatter, HtmlContext, HtmlWriter};
...
/// [`NodeViewParts`](crate::runtime::NodeViewParts),
/// [`AttributeValueViewParts`], [`AttributeKeyViewParts`],
/// [`ElementNameViewParts`](crate::runtime::ElementNameViewParts), or
/// [`AttributeViewParts`](crate::runtime::AttributeViewParts).
///
...
impl<'a> PartsWriter<'a> {
    ...
    /// [`Attribute`](crate::runtime::Attribute) transition between the
    /// positions they span.
    #[inline]
