...
///
/// Read cookies with [`get`](Self::get), or queue changes with
/// [`add`](Self::add) and [`remove`](Self::remove). Configure a jar with the
/// provided methods to apply protection and attributes to its cookies.
///
