...
///
/// Pass `checked` to set its initial state. Attributes are forwarded to the
/// `<input>`, while classes are appended to the wrapper. The indeterminate
/// state requires scripting and has no dedicated styling.
///
/// ```ignore
/// view! {
