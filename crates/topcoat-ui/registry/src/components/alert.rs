...
/// A notice about the current page.
///
/// Choose its appearance with `variant`. Place an optional icon before the
/// title and description. Attributes are forwarded to the `<div>`, and
