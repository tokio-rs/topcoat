use topcoat::{
    Result,
    view::{Class, PromotedStr, Unescaped, class, component, view},
};
...
const PAGE_LINK: Class<Unescaped<PromotedStr>> =
    class!("rounded-md px-3 py-2 font-medium text-slate-600 hover:bg-slate-100");
const PAGE_DISABLED: Class<Unescaped<PromotedStr>> =
    class!("rounded-md px-3 py-2 font-medium text-slate-300");
const PAGE_CURRENT: Class<Unescaped<PromotedStr>> =
