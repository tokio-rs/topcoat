...
/// External links shown in the showcase.
...
/// Alert examples shown without a surrounding card.
#[component]
...
/// Shows links for the first, last, and current pages to keep pagination
/// compact. Other runs of pages become an ellipsis.
